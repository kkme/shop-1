<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TuanFruit.News.Index" %>
                ...
                <div class="productmain">
                    ...
                    <div class="productright">
                        <div class="product_urldh">
                            <ul>
                                <li><a href="/Default">首页</a></li><li>&gt;</li><li><a href="#"><%=newstitleHTML%></a></li></ul>
                        </div>
                        <div id="contentinfo">
